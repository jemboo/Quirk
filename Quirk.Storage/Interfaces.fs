...
type IProjectDataStore =
    ...
    abstract member GetNextScript : string<projectName> -> Result<string<scriptName>*quirkScript, string>
    ...
    abstract member GetCfgPlex : string<projectName> -> string<cfgPlexName> -> Result<cfgPlex, string>
